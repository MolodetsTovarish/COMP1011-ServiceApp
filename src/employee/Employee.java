...
public abstract class Employee {
     ...
     * @param day
     *
     * The constructor for the base Employee class, which has all the basic
     * information that will be extended to all the child employee classes
     */
    ...
    /**
     *
     * @return String This method returns the employee's first name
     */
    ...
    /**
     *
     * @param firstName This method sets the employee's first name
     */
    ...
    /**
     *
     * @return String This method returns the employee's last name
     */
    ...
    /**
     *
     * @param lastName This method sets the employee's last name
     */
    ...
    /**
     *
     * @return String This method returns the employee's full name
     */
    ...
    /**
     *
     * @return int This method returns the employee's ID number
     */
    ...
    /**
     *
     * @return int This method returns the employee's contact number
     */
    ...
    /**
     *
     * @param contactNum This method sets the employee's contact number
     */
     ...
     * @return double
     *
     * An abstract payment method that can be overriden in the child classes to
     * get their unique pay calculations
     */
